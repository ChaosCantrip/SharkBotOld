...
anniversary = Collection("ANI", "Anniversary", "anniversary_item", discord.Color.dark_gold(), 7, 1800)
timelost = Collection("TL", "Timelost", "timelost_item", discord.Color.dark_gold(), 5, 1900)
