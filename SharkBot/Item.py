...
currentEventBoxID: Optional[list[str]] = None
currentEventBox: Optional[list[Lootbox]] = None
if currentEventBoxID is not None:
    currentEventBox = [get(event_box_id) for event_box_id in currentEventBoxID]
